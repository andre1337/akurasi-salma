...
class PDF extends FPDF{
  function Header(){
    ...
    $this->Cell(20,0,'Data pengeluaran',0,0,'L');
    $this->Ln();
    $this->Cell(5,1,'Laporan data pengeluaran',0,0,'L');
    $this->Ln();
...
$pdf->Cell(2,1,'id_pengeluaran','LR',0,'C',1);
...
for ($j=0;$j<$i;$j++){
  ...
  $pdf->Cell(2,1,$cell[$j][0],'B',0,'L'); // id_pengeluaran
